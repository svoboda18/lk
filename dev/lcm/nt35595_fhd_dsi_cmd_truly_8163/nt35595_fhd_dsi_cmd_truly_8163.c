...
static INT32 lcm_display_mode_switch(bool gram_en,bool int_clk_en,UINT8*pAddr,UINT8*pVal)
{
	UINT8 gram=0;
	UINT8 int_clk=0;

	gram=gram_en ? 0x10:0;  //enable 0x10, disable 0
	int_clk=int_clk_en?0:3; //enable 0, disable 3
