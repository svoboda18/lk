...
#ifndef MACH_FPGA
#if (LCM_DSI_CMD_MODE)
	params->dsi.PLL_CLOCK = 130; //this value must be in MTK suggested table
#else
	params->dsi.PLL_CLOCK = 115; //this value must be in MTK suggested table
#endif
#else
...
LCM_DRIVER nt35595_fhd_dsi_cmd_truly_nt50358_qhd_lcm_drv=
{
    .name           	= "nt35595_fhd_dsi_cmd_truly_nt50358_qhd_drv",
