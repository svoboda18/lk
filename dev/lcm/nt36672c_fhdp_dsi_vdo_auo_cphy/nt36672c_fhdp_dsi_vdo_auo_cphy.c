...
#define LCM_ID_NT36672C (0x6A) // TO DO
...
#else
	params->dsi.PLL_CLOCK = 566;	/* this value must be in MTK suggested table */
#endif
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s,nt3672a_id=0x%08x,version_id=0x%x\n", __func__, id, version_id);
...
LCM_DRIVER nt36672c_fhdp_dsi_vdo_auo_cphy_lcm_drv = {
	.name = "nt36672c_fhdp_dsi_vdo_auo_cphy_lcm_drv",
