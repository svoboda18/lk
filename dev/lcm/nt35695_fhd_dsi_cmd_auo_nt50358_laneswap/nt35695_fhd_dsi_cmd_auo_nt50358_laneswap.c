...
static struct LCM_setting_table init_setting[] = {
	...
	{0xFF, 1, {0x10} },
	{0x34, 1, {0x00} },//////////Tearing Effect Line OFF

	{0x35, 1, {0x02} },//////////Tearing Effect Line OFF//0822MODIFIED!!!!!!!!!!!!!!!
...
#ifndef MACH_FPGA
#if (LCM_DSI_CMD_MODE)
	params->dsi.PLL_CLOCK = 410;	/* this value must be in MTK suggested table */
#else
