...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	/* #Display setting 1 */
	/* {0xC1, 35, {0x00,0x61,0x00,0x20,0x8C,0xA4,0x16,0xFB,0xBF,0x98,0x83,0xDC,0x7B,0xCF,0x35,0x74,0x4C,0xF9,
	  0x9F,0x2D,0x95,0x88,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x60,0x23,0x03,0x00,0xFF,0x11}}, */
	{0xC1, 35,
	 {0x00, 0x61, 0x00, 0x20, 0x8C, 0xA4, 0x16, 0xFB, 0xBF, 0x98, 0x83, 0x9A, 0x7B, 0xCF, 0x35, 0x74, 0x4C, 0xF9,
	  0x9F, 0x2D, 0x95, 0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x63, 0x23, 0x03, 0x00, 0xFF, 0x11} },
	/* #Display setting 2 */
	...
	/* #LTPS timing setting */
	{0xC6, 21,
	 {0x5A, 0x29, 0x29, 0x01, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06,
	  0x15, 0x08, 0x5A} },
	/* #Panel pin control */
	...
	{0xC7, 30,
	 {0x00, 0x0C, 0x14, 0x1D, 0x2C, 0x3A, 0x44, 0x54, 0x38, 0x40, 0x4C, 0x59, 0x63, 0x6B, 0x7F, 0x00, 0x0C, 0x14,
	  0x1D, 0x2C, 0x3A, 0x44, 0x54, 0x38, 0x40, 0x4C, 0x59, 0x63, 0x6B, 0x7F} },
	{0xC8, 19,
	 {0x01, 0x00, 0x00, 0x00, 0x00, 0xFC, 0xEF, 0x00, 0x00, 0x00, 0x00, 0xFC, 0xEF, 0x00, 0x00, 0x00, 0x00, 0xFC,
	  0x0F} },
	...
	{0xCE, 25,
	 {0x55, 0x40, 0x49, 0x53, 0x59, 0x5E, 0x63, 0x68, 0x6E, 0x74, 0x7E, 0x8A, 0x98, 0xA8, 0xBB, 0xD0, 0xFF, 0x04,
	  0x00, 0x04, 0x04, 0x00, 0x00, 0x69, 0x5A} },
	/* self check module */
...
static void lcm_init(void)
{
	...
	if (ret < 0)
		pr_err("[KERNEL]r63419----tps6132---cmd=%0x-- i2c write error-----\n", cmd);
	else
...
#else
	pr_info("%s, kernel r63419 horse debug: r63419 id = 0x%08x\n", __func__, lcd_id);
#endif
...
#else
	pr_info("%s, kernel R63419 backlight: level = %d\n", __func__, level);
#endif
