...
//  Extern Variable
// ---------------------------------------------------------------------------
extern unsigned int g_lcm_inversion; /* LCM inversion, for *#87# lcm flicker test */
...
static struct NT5038_SETTING_TABLE nt5038_cmd_data[4] = {
	{ 0x00, 0x12 },
	{ 0x01, 0x12 },
	{ 0x03, 0x33 },
	{ 0xFF, 0x80 }
...
static void lcm_init_power(void)
{
	...
	MDELAY(1);
	nt5038_i2c_write_byte(nt5038_cmd_data[3].cmd, nt5038_cmd_data[3].data);
	MDELAY(15);
}
...
LCM_DRIVER nt36672ah_hdp_dsi_vdo_tcl_csot_lcm_drv =
{
