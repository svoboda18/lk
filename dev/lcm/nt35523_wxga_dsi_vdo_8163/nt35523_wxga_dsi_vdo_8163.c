...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xB0,1,{0x40}},
	{0xD1,16,{0x00,0x00,0x00,0x11,0x00,0x30,0x00,0x49,0x00,0x5F,0x00,0x84,0x00,0xA1,0x00,0xD3}},
	{0xD2,16,{0x00,0xFB,0x01,0x3B,0x01,0x6E,0x01,0xBF,0x02,0x00,0x02,0x02,0x02,0x3E,0x02,0x7E}},
	{0xD3,16,{0x02,0xA6,0x02,0xDC,0x03,0x01,0x03,0x34,0x03,0x56,0x03,0x80,0x03,0x9E,0x03,0xC0}},
...
static int lcm_adjust_fps(void * cmdq, int fps)
{
	...
	if (fps == 60) {
		lcm_fps = 60;
		push_table(lcm_fps_60_setting, sizeof(lcm_fps_60_setting) / sizeof(struct LCM_setting_table), 1);
	} else if (fps == 120) {
		lcm_fps = 120;
		push_table(lcm_fps_120_setting, sizeof(lcm_fps_120_setting) / sizeof(struct LCM_setting_table), 1);
	} else {
		return -1;
