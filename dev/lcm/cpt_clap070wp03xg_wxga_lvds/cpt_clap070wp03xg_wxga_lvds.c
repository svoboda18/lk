...
/* GPIO113       VDD18_LVDS for SN65DSI83 power */
...
/* GPIO118       AVDDVGH/VGL/VCOM for panel power */
#ifdef GPIO_LCM_PWR
...
/* GPIO112       LVDS_EN_R for SN65DSI83 */
...
static void lcm_suspend(void)
{
	...
	lcm_set_gpio_output(GPIO_LCD_PWR_EN, GPIO_OUT_ZERO);      /* LCMBIASON :VGH VHL */
	MDELAY(20);

	lcm_set_gpio_output(GPIO_LCD_PWR, GPIO_OUT_ZERO);    /* LCM VCC :enable LCD VCC */
	MDELAY(20);
...
LCM_DRIVER cpt_clap070wp03xg_wxga_lvds_lcm_drv = {
