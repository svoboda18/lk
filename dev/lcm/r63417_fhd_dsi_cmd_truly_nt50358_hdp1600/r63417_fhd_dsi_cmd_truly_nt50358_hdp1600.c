...
#endif
	if(ret < 0)
		LCM_LOGI("r63417----tps65132----cmd=%0x--i2c write error----\n",cmd);
	else
		LCM_LOGI("r63417----tps65132---cmd=%0x-- i2c write success-----\n",cmd);
...
static unsigned int lcm_compare_id(void)
{
	...
	LCM_LOGI("%s, r63417 debug: r63417 id = 0x%08x\n", __func__, id);
	if(id == LCM_ID_R63417)
		return 1;
	else
		return 0;
...
{
	LCM_LOGD("%s,r63417 backlight: level = %d\n", __func__, level);
...
LCM_DRIVER r63417_fhd_dsi_cmd_truly_nt50358_hdp1600_lcm_drv=
{
