...
enum {
	...
	AEE_PLAT_INFRA_CG,
	AEE_PLAT_ADSP_COREDUMP,
#ifdef MTK_TINYSYS_MCUPM_SUPPORT
	AEE_PLAT_MCUPM_COREDUMP,
	AEE_PLAT_MCUPM_DATA,
	AEE_PLAT_MCUPM_XFILE,
	AEE_PLAT_MCUPM_LAST_LOG,
#endif
#ifdef MTK_PICACHU_SUPPORT
	AEE_PLAT_PICACHU_LOG,
#endif
	AEE_PLAT_DEBUG_NUM,
};
...
#endif
extern unsigned int (* plat_infra_cg_get)(u64 offset, int *len, CALLBACK dev_write);
#ifdef MTK_AUDIODSP_SUPPORT
extern unsigned int (* plat_adsp_coredump_get)(u64 offset, int *len, CALLBACK dev_write);
#endif
#ifdef MTK_TINYSYS_MCUPM_SUPPORT
extern unsigned int (* plat_mcupm_coredump_get)(u64 offset, int *len, CALLBACK dev_write);
extern unsigned int (* plat_mcupm_data_get)(u64 offset, int *len, CALLBACK dev_write);
extern unsigned int (* plat_mcupm_xfile_get)(u64 offset, int *len, CALLBACK dev_write);
extern unsigned int (* plat_mcupm_log_get)(u64 offset, int *len, CALLBACK dev_write);
#endif
#ifdef MTK_PICACHU_SUPPORT
extern unsigned int (* plat_picachu_log_get)(u64 offset, int *len, CALLBACK dev_write);
#endif
