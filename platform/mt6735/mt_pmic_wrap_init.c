...
static inline U32 wait_for_state_ready_init(loop_condition_fp fp,U32 timeout_us,volatile U32 *wacs_register,U32 *read_reg)
{
...
static inline U32 wait_for_state_idle_init(loop_condition_fp fp,U32 timeout_us,volatile U32 *wacs_register,volatile U32 *wacs_vldclr_register,U32 *read_reg)
{
...
static inline U32 wait_for_state_idle(loop_condition_fp fp,U32 timeout_us,volatile U32 *wacs_register,volatile U32 *wacs_vldclr_register,U32 *read_reg)
{
...
static inline U32 wait_for_state_ready(loop_condition_fp fp,U32 timeout_us,volatile U32 *wacs_register,U32 *read_reg)
{
...
static S32 _pwrap_init_reg_clock( U32 regck_sel )
{
  //U32 wdata=0;
	...
	if( regck_sel == 1 ) { // 6MHz in 6323  => no support ; 18MHz in 6320
		...
		WRAP_WR32(PMIC_WRAP_CSHEXT_WRITE   , 0x33);// wait data written into register => 3T_PMIC: consists of CSLEXT_END(1T) + CSHEXT(6T)
...
static S32 _pwrap_status_update_test_porting( void )
{
#if defined (SLV_6325) || defined (SLV_6332)
  U32 rdata;
#endif
...
#ifdef SLV_6325
  pwrap_write(MT6325_DEW_WRITE_TEST, MT6325_WRITE_TEST_VALUE);
  ...
  if( (rdata&0xFFFF) != MT6325_WRITE_TEST_VALUE )
  {
    PWRAPERR("MT6325 _pwrap_status_update_test error,error code=%x, rdata=%x\n", 1, (rdata&0xFFFF));
    //return 1;
  }
#endif
#ifdef SLV_6332
...
#endif
#ifdef SLV_6325
  WRAP_WR32(PMIC_WRAP_SIG_VALUE,MT6325_WRITE_TEST_VALUE);//tha same as write test
#endif
#ifdef SLV_6332
...
#ifdef SLV_6325
  WRAP_WR32(PMIC_WRAP_SIG_ADR, MT6325_DEW_CRC_VAL);
#endif
#ifdef SLV_6332
  WRAP_WR32(PMIC_WRAP_SIG_ADR, (MT6332_DEW_CRC_VAL<<16)|WRAP_RD32(PMIC_WRAP_SIG_ADR));
#endif
  return 0;
}
