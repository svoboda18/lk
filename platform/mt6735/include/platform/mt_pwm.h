...
#define	PWM_3DLCM_2_INV	2
#define	PWM_3DLCM_1_INV	1                     
#define	PWM_3DLCM_0_INV	0
...
S32 pwm_set_easy_config ( struct pwm_easy_config *);
S32 pwm_set_spec_config(struct pwm_spec_config *);
