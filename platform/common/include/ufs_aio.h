...
extern struct ufs_platform_info ufs_platform;
...
enum ufs_desc_max_size {
	QUERY_DESC_DEVICE_MAX_SIZE              = 0x40,	/* HPB 1.0: 0x48, HPB 2.0 & TW: 0x57 */
	QUERY_DESC_CONFIGURAION_MAX_SIZE        = 0x90,
	QUERY_DESC_CONFIGURAION_MAX_SIZE_HPB    = 0xD0, /* HPB 1.0: 0xD0 */
	QUERY_DESC_CONFIGURAION_MAX_SIZE_HPB_20 = 0xE2, /* HPB 2.0: 0xE2 */
	...
	QUERY_DESC_GEOMETRY_MAX_SIZE            = 0x44, /* UFS 2.0: 0x44, UFS 2.1: 0x48, HPB 1.0: 0x50, HPB 2.0: 0x58 */
	QUERY_DESC_POWER_MAX_SIZE               = 0x62,
	QUERY_DESC_HEALTH_MAX_SIZE              = 0x2D, /* UFS 3.0: 0x2D */
	QUERY_DESC_RFU_MAX_SIZE                 = 0x00,
};

/* Geometry descriptor parameters offsets in bytes */
enum geometry_desc_param {
	GEOMETRY_DESC_PARAM_RPMB_READ_WRITE_SIZE = 0x17,
};
...
enum device_desc_param {
	...
	DEVICE_DESC_PARAM_EXT_FEAT_SUP          = 0x4F,
	DEVICE_DESC_PARAM_TW_BUF_USER_REDUCED   = 0x53,
...
enum conf_desc_param {
	...
	CONF_DESC_B_HPB_CINTROL             = 0xB,  /* JEDEC version */
	CONF_DESC_B_TW_BUF_NO_RED_EN        = 0x10,
	CONF_DESC_B_TW_BUF_TYPE             = 0x11,
	CONF_DESC_D_NUM_SHARED_WB_BUF_AU    = 0x12, /* JEDEC version */
	...
	CONF_DESC_UNIT_W_MAX_ACTIVE_HPB_REGIONS      = 0x10,
	CONF_DESC_UNIT_W_HPB_PINNED_REGION_START_IDX = 0x12,
	CONF_DESC_UNIT_W_NUM_HPB_PINNED_REGIONS      = 0x14,
	CONF_DESC_UNIT_D_NUM_TW_BUF_AU               = 0x16
};

enum helath_desc_param {
	HEALTH_DESC_B_LENGTH                  = 0x0,
	HEALTH_DESC_B_DESCRIPTOR_IDN          = 0x1,
	HEALTH_DESC_B_PRE_EOL_INFO            = 0x2,
	HEALTH_DESC_B_DEVICE_LIFE_TIME_EST_A  = 0x3,
	HEALTH_DESC_B_DEVICE_LIFE_TIME_EST_B  = 0x4,
};
...
#define UFS_BOOT_LU_SIZE_BYTE_DEC       (16 * 1024 * 1024)   // 16 MB
...
#define ATTR_B_REF_CLK_FREQ                 (0xA)
