...
/* Notice: ufs_lk_otp_lock() can not be called in normal boot. Suggest call in fastboot mode. */
...
status_t            interface_ufs_erase(u64 address, u64 length, const struct progress_cb* cb);
