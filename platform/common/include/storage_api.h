...
/* functions */
ssize_t storage_read(uint32_t phys_part, uint64_t offset, uint8_t *buf, uint32_t size);
ssize_t storage_write(uint32_t phys_part, uint64_t offset, uint8_t *buf, uint32_t size);
int32_t storage_erase(int32_t dev_num, uint64_t offset, uint32_t size, uint32_t phys_part);
