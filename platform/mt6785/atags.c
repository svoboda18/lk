...
extern int target_fdt_dram_memtest(void *fdt);
...
{
	unsigned int platform_type = (get_devinfo_with_index(5) >> 27) & 0x1; /* 0: smartphone, 1: tablet */
	unsigned int segment = get_devinfo_with_index(30) & 0xFF;
	int model_index = 0;
	const char *model_name[] = {
		"MT6783V/CU", // index:0 code:0x80,
		"MT6783V/WU", // index:1 code:0x01,
		"MT6783V/CB", // index:2 code:0x40,
		"MT6783V/WB", // index:3 code:0x02,
		"MT6785V/CU", // index:4 code:0xC0,
		"MT6785V/WU", // index:5 code:0x03,
		"MT6785V/CB", // index:6 code:0x20,
		"MT6785V/WB", // index:7 code:0x04,
		"MT6785V/CV", // index:8 code:0xA0,
		"MT6785V/WV", // index:9 code:0x05,
		"MT6785V/CC", // index:10 code:0x60,
		"MT6785V/WC", // index:11 code:0x06,
	};
	...
	**********************************************************************/
	...
	if (prop) {
		int namestroff;
		const char *str = model_name[model_index];
...
int platform_atag_append(void *fdt)
{
	...
	extern int platform_fdt_spm(void *fdt)__attribute__((weak));
	platform_fdt_spm(fdt);
#endif
