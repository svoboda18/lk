...
#define SCP_DRAM_SIZE       0x00300000  // mblock_reserve requires max 3 MB
#else
...
#define SCP_SRAM_SIZE            0x000c0000
...
#define SCP_L1C_OFFSET              0x100000  //fixed offset
#define SCP_L1C_SIZE                0x100000 //1MB
#define SCP_L1C_BACKUO_OFFSET       0x200000 //fixed offset
