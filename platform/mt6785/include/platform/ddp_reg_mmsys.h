...
#define DISP_REG_CONFIG_MMSYS_CG_CLR0		MMCON(0x108)
	...
	#define FLD_CG0_SMI_LARB1		REG_FLD(1, 2)
	#define FLD_CG0_GALS_COMMON0		REG_FLD(1, 3)
	#define FLD_CG0_GALS_COMMON1		REG_FLD(1, 4)
	#define FLD_CG0_OVL0			REG_FLD(1, 20)
	#define FLD_CG0_OVL0_2L			REG_FLD(1, 21)
	#define FLD_CG0_OVL1_2L			REG_FLD(1, 22)
	#define FLD_CG0_RDMA0			REG_FLD(1, 23)
	#define FLD_CG0_RDMA1			REG_FLD(1, 24)
	#define FLD_CG0_WDMA0			REG_FLD(1, 25)
	#define FLD_CG0_COLOR0			REG_FLD(1, 26)
	#define FLD_CG0_CCORR0			REG_FLD(1, 27)
	#define FLD_CG0_AAL0			REG_FLD(1, 28)
	#define FLD_CG0_GAMMA0			REG_FLD(1, 29)
	#define FLD_CG0_DITHER0			REG_FLD(1, 30)
	#define FLD_CG0_SPLIT			REG_FLD(1, 31)
...
#define DISP_REG_CONFIG_MMSYS_CG_CLR1		MMCON(0x118)
	#define FLD_CG1_DSI0_MM			REG_FLD(1, 0)
	#define FLD_CG1_DSI0_IF			REG_FLD(1, 1)
	#define FLD_CG1_DPI_MM			REG_FLD(1, 2)
	#define FLD_CG1_DPI_IF			REG_FLD(1, 3)
	#define FLD_CG1_26M			REG_FLD(1, 7)
	#define FLD_CG1_RSZ0			REG_FLD(1, 9)
	#define FLD_CG1_POSTMASK		REG_FLD(1, 14)
