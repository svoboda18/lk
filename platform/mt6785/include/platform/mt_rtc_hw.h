...
#define RTC_BBPU_SPAR_SW			(PMIC_SPAR_SW_MASK << PMIC_SPAR_SW_SHIFT)
#define RTC_BBPU_RESET_SPAR			(PMIC_RESET_SPAR_MASK << PMIC_RESET_SPAR_SHIFT)
#define RTC_BBPU_RESET_ALARM		(PMIC_RESET_ALARM_MASK << PMIC_RESET_ALARM_SHIFT)
...
#define RTC_BBPU_2SEC_MODE_MSK		(PMIC_BBPU_2SEC_MODE_MASK << PMIC_BBPU_2SEC_MODE_SHIFT) /* RTC mask include shift */
...
#define RTC_XOSCCALI_MASK			(PMIC_XOSCCALI_MASK << PMIC_XOSCCALI_SHIFT)		/*Default 4'b0111, 2nd step suggest to set to 4'b0000 EOSC_CALI = charging cap calibration*/
#define RTC_XOSC32_ENB				(PMIC_RTC_XOSC32_ENB_MASK << PMIC_RTC_XOSC32_ENB_SHIFT)	/* 0 (32k crystal exist)	1 (32k crystal doesn't exist)*/
...
#define RTC_GP_OSC32_CON				(2U << PMIC_RTC_GP_OSC32_CON_SHIFT) /* Keep RG_EOSC_RSV[0] to low for lower EOSC leakage current hardware design change. */
#define RTC_REG_XOSC32_ENB			(PMIC_RTC_REG_XOSC32_ENB_MASK << PMIC_RTC_REG_XOSC32_ENB_SHIFT)

#define RTC_EMBCK_SEL_HW 			(0 << PMIC_RTC_EMBCK_SEL_MODE_SHIFT)	/* 0: emb_hw	1: emb_k_eosc_32		2:dcxo_ck	3: eosc32_ck*/
...
*      bit 7 	 : low power detect bit. True:enable, False:disable
...
#define RTC_CON_GOE					(PMIC_GOE_MASK << PMIC_GOE_SHIFT)	/* 1: GPO mode, 0: GPI mode */
