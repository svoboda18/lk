...
#define IO_CFG_LT_DRV_CFG1				(IOCFG_LT_BASE+0x010)
#define IO_CFG_LT_DRV_CFG1_SET				(IOCFG_LT_BASE+0x014)
#define IO_CFG_LT_DRV_CFG1_CLR				(IOCFG_LT_BASE+0x018)
#define IO_CFG_LM_PD_CFG0_SET				(IOCFG_LM_BASE+0x034)
#define IO_CFG_LM_PD_CFG0_CLR				(IOCFG_LM_BASE+0x038)
#define IO_CFG_LM_PU_CFG0_SET				(IOCFG_LM_BASE+0x044)
#define IO_CFG_LM_PU_CFG0_CLR				(IOCFG_LM_BASE+0x048)
#define IO_CFG_RM_DRV_CFG0_SET				(IOCFG_RM_BASE+0x004)
#define IO_CFG_RM_DRV_CFG0_CLR				(IOCFG_RM_BASE+0x008)
