...
void init_cfg_cache_latch(struct plt_cfg_cache_latch *p_cfg_cache_latch, unsigned int cache_level)
{
	p_cfg_cache_latch->support_level = 0;
	p_cfg_cache_latch->ops.init = NULL;
	p_cfg_cache_latch->ops.has_error = NULL;
	p_cfg_cache_latch->ops.dump = NULL;
	p_cfg_cache_latch->ops.reset = NULL;
	p_cfg_cache_latch->reg_info.ctrl_offset = 0;
	p_cfg_cache_latch->reg_info.ctrl_mask = 0;
	p_cfg_cache_latch->reg_info.dump_offset = 0;
	p_cfg_cache_latch->reg_info.dump_length = 0;

	switch (cache_level) {
	case 0:
		p_cfg_cache_latch->support_level = 0x0000000C;
		break;
	case 2:
		p_cfg_cache_latch->reg_info.ctrl_offset = 0x8090;
		p_cfg_cache_latch->reg_info.ctrl_mask = 0x0000FF00;
		p_cfg_cache_latch->reg_info.dump_offset = 0x8090;
		p_cfg_cache_latch->reg_info.dump_length = 68;
		break;
	case 3:
		p_cfg_cache_latch->reg_info.ctrl_offset = 0xC8C0;
		p_cfg_cache_latch->reg_info.ctrl_mask = 0x01000001;
		p_cfg_cache_latch->reg_info.dump_offset = 0xC8C0;
		p_cfg_cache_latch->reg_info.dump_length = 12;
	default:
		break;
	}
}
