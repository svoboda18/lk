...
U32 PWM_register[PWM_NUM]= {
	...
	(PWM_BASE+0x0150),     //PWM6 register base    15 registers
};
...
#define    MT_CG_INFRA_PWM5      20
#define    MT_CG_INFRA_PWM_FBCLK6 0 /* For PWM6 cg */
...
/* For PWM6 cg control */
#define PWM6_CLOCK_STA   (INFRACFG_AO_BASE + 0x00ac)
#define PWM6_CLOCK_SET   (INFRACFG_AO_BASE + 0x00a4)
#define PWM6_CLOCK_CLR   (INFRACFG_AO_BASE + 0x00a8)
...
void mt_pwm_power_on(U32 pwm_no)
{
	...
	switch(pwm_no) {
		...
		case 3:
			...
			break;
		case 4:
			PWM_SET_BITS(PWM_CLOCK_CLR, (1<<(MT_CG_INFRA_PWM5)));
			break;
		case 5:
			PWM_SET_BITS(PWM_CLOCK_CLR, (1<<(MT_CG_INFRA_PWM_FBCLK6)));
			break;
		default:
...
void mt_pwm_power_off (U32 pwm_no)
{
	...
	switch(pwm_no) {
		...
		case 3:
			...
			break;
		case 4:
			PWM_SET_BITS(PWM_CLOCK_SET, (1<<(MT_CG_INFRA_PWM5)));
			break;
		case 5:
			PWM_SET_BITS(PWM_CLOCK_SET, (1<<(MT_CG_INFRA_PWM_FBCLK6)));
			break;
		default:
			PWMDBG("Invalid PWM num\n");
	}
