...
#define MT_GPT_IRQ_ID   146
#define MT_USB0_IRQ_ID  49
#define MT_SSUSB_IRQ_ID 159
#define MT_NFI_IRQ_ID   128 /* fixme: need to confirm after SB do nand flash boot */
#define MT_MSDC0_IRQ_ID 55
#define MT_MSDC1_IRQ_ID 56

#define MT_NR_PPI   (5)
#define MT_NR_SPI   (352)
#define NR_IRQ_LINE  (GIC_PPI_OFFSET + MT_NR_PPI + MT_NR_SPI)    // 5 PPIs and 352 SPIs
