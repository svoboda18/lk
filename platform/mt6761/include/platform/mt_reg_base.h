...
// APB Module mbist_ao
#define MBIST_AO_BASE       (0x10013000)
...
#define DRAMC_NAO_BASE (0x1021D000)
...
// APB Module dramc_conf_nao
#define DRAMC1_NAO_BASE (0x1021D000)
...
#define MIPI_TX1_BASE (0xffffffff) /*Cervino no this module */

// MIPI TX Config
#define MIPI_TX_CONFIG_BASE (0x11c80000)

// APB Module mipi_rx_ana_csi0
#define MIPI_RX_ANA_CSI0_BASE (0x11C10000)

// APB Module mipi_rx_ana_csi1
#define MIPI_RX_ANA_CSI1_BASE (0x11C20000)

// APB Module mipi_rx_ana_csi2
#define MIPI_RX_ANA_CSI2_BASE (0x11C30000)
...
#define DISP_OVL1_2L_BASE (0xffffffff)/*Cervino no this module */
#define DISP_RDMA0_BASE (0x1400d000)
#define DISP_RDMA1_BASE (0xffffffff)/*Cervino no this module */
#define DISP_WDMA0_BASE (0x1400e000)
#define DISP_SPLIT0_BASE (0xffffffff)/*Cervino no this module */
#define DSI0_BASE (0x14014000)
#define DSI1_BASE (0xffffffff)/*Cervino no this module */
...
#define SMI_LARB4_BASE (0x14018000)
