...
struct mtk_charger_ops {
	...
	int (*set_bl_driver)(struct mtk_charger_info *mchr_info);
};
...
extern int mtk_charger_enable_wdt(struct mtk_charger_info *mchr_info, bool en);
extern int mtk_charger_set_bl_driver(struct mtk_charger_info *mchr_info);
