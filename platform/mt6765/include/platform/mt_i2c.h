...
#define I2C_CLK_RATE        (FPGA_CLOCK / (I2C_CLK_DIV * 2)) /* I2C base clock (KHz) */
#define SCP_I2C_CLK     (FPGA_CLOCK / 16)
#else
/* TODO: Calculate from bus clock, unit:kHZ */
/* 15600k = 78M/5; 24960k = 124.8M/5 */
#define I2C_CLK_RATE        24960
#define I2C_CLK_DIV     5 /* frequency divisor */
...
typedef struct mt_i2c_t {
	...
	U16     multi_offset;//The offset of the multi-channel
