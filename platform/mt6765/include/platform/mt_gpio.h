...
#if (!defined(MACH_FPGA)) && (!defined(USE_DTB_NO_DWS))
...
/* mutex_t gpio_mutex; *//* delete by xuexi as it needn't now */
/******************************************************************************
...
/*----------------------------------------------------------------------------*/
typedef struct {
    VAL_REGS    dir[16];/* 0x0000 ~ 0x00FF: 256 bytes */
    VAL_REGS    dout[16];/* 0x0100 ~ 0x01FF: 256 bytes */
    VAL_REGS    din[16];/* 0x0200 ~ 0x02FF: 256 bytes */
    VAL_REGS    mode[33];/* 0x0300 ~ 0x0510: 528 bytes */
} GPIO_REGS;
/*----------------------------------------------------------------------------*/
typedef struct {
	unsigned int no     : 16;
