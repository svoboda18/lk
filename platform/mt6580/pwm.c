...
U32 PWM_register[PWM_NUM]={          
	...
	(PWM_BASE+0x0110), //PWM5 register base, 15 registers
};

#define CLK_GATING_CTRL1 (TOPCKGEN_BASE + 0x24)
#define CLK_GATING_CTRL2 (TOPCKGEN_BASE + 0x3C)
#define SET_CLK_GATING_CTRL1 (TOPCKGEN_BASE + 0x54)
#define SET_CLK_GATING_CTRL2 (TOPCKGEN_BASE + 0x6C)
#define CLR_CLK_GATING_CTRL1 (TOPCKGEN_BASE + 0x84)
#define CLR_CLK_GATING_CTRL2 (TOPCKGEN_BASE + 0x9C)

#define MT_CG_PWM_SW_CG          9
#define MT_CG_PWM_BCLK_SW_CG     8
#define MT_CG_PWM1_FBCLK_SW_CG   9
#define MT_CG_PWM2_FBCLK_SW_CG   10
#define MT_CG_PWM3_FBCLK_SW_CG   11
#define MT_CG_PWM4_FBCLK_SW_CG   12
#define MT_CG_PWM5_FBCLK_SW_CG   13
...
{
	PWM_SET_BITS(CLR_CLK_GATING_CTRL1, (1<<MT_CG_PWM_SW_CG));
	PWM_SET_BITS(CLR_CLK_GATING_CTRL2, (1<<MT_CG_PWM_BCLK_SW_CG));
	PWM_SET_BITS(CLR_CLK_GATING_CTRL2, (1<<(MT_CG_PWM1_FBCLK_SW_CG+pwm_no)));  //enable clock 
...
{
	PWM_SET_BITS(SET_CLK_GATING_CTRL2, (1<<(MT_CG_PWM1_FBCLK_SW_CG+pwm_no)));  //disable clock 
	//PWM_SET_BITS(SET_CLK_GATING_CTRL2, (1<<MT_CG_PWM_BCLK_SW_CG));
	//PWM_SET_BITS(SET_CLK_GATING_CTRL1, (1<<MT_CG_PWM_SW_CG));  //disable bus clock 
...
{
	if ( pwm_no >= PWM_MAX ) {
		PWMDBG ( "pwm number is not between PWM1~PWM5(0~4)\n" );
		return -EEXCESSPWMNO;
	}
