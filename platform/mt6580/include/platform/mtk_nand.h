...
#define NFI_PAGEFMT_REG16   ((volatile P_U32)(NFI_BASE+0x0004))
...
#define MT_CLKMUX_NFI1X_INFRA_SEL   ((volatile P_U32)(0x10000000+0x0004))

#define NFI_DQS_DELAY_CTRL   ((volatile P_U32)(0x10015000+0x00B4))
#define NFI_DQS_DELAY_MUX    ((volatile P_U32)(0x10015000+0x00D0))
...
#define ECC_ENCSTA_REG32    ((volatile P_U32)(NFIECC_BASE+0x00A0))
#define ECC_ENCIRQEN_REG16  ((volatile P_U16)(NFIECC_BASE+0x00A4))
#define ECC_ENCIRQSTA_REG16 ((volatile P_U16)(NFIECC_BASE+0x00A8))
