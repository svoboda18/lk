...
#define SPM_VDE_PWR_CON			(SPM_BASE + 0x210)//not support, not in CODA
...
#define SPM_MJC_PWR_CON			(SPM_BASE + 0x298)//not in CODA
#define SPM_AUDIO_PWR_CON		(SPM_BASE + 0x29c)//not in CODA
#define SPM_CA15_CPU0_PWR_CON		(SPM_BASE + 0x2a0)//not support, not in CODA
#define SPM_CA15_CPU1_PWR_CON		(SPM_BASE + 0x2a4)//not support, not in CODA
#define SPM_CA15_CPU2_PWR_CON		(SPM_BASE + 0x2a8)//not support, not in CODA
#define SPM_CA15_CPU3_PWR_CON		(SPM_BASE + 0x2ac)//not support, not in CODA
#define SPM_CA15_CPUTOP_PWR_CON		(SPM_BASE + 0x2b0)//not support, not in CODA
#define SPM_CA15_L1_PWR_CON		(SPM_BASE + 0x2b4)//not support, not in CODA
#define SPM_CA15_L2_PWR_CON		(SPM_BASE + 0x2b8)//not support, not in CODA
#define SPM_MFG_2D_PWR_CON      (SPM_BASE + 0x2c0) // Need to remove, not in CODA
#define SPM_MFG_ASYNC_PWR_CON		(SPM_BASE + 0x2c4)//not support, not in CODA
#define SPM_MD32_SRAM_CON		(SPM_BASE + 0x2c8)//not in CODA
#define SPM_ARMPLL_DIV_PWR_CON  (SPM_BASE + 0x2cc)//not in CODA
#define SPM_MD2_PWR_CON         (SPM_BASE + 0x2d0)//not in CODA
#define SPM_C2K_PWR_CON         (SPM_BASE + 0x2d4)//not in CODA
#define SPM_INFRA_MD_PWR_CON    (SPM_BASE + 0x2d8)//not in CODA
...
#define SPM_SLEEP_DUAL_VCORE_PWR_CON	(SPM_BASE + 0x404)//not in CODA
#define SPM_SLEEP_PTPOD2_CON		(SPM_BASE + 0x408)//not in CODA
...
#define SPM_BSI_DO_SR		      (SPM_BASE + 0x62c)//not in CODA
#define SPM_BSI_D1_SR		      (SPM_BASE + 0x630)//not in CODA
#define SPM_BSI_D2_SR		      (SPM_BASE + 0x634)//not in CODA
#define SPM_AP_SEMA		        (SPM_BASE + 0x638)//not in CODA
#define SPM_SPM_SEMA		      (SPM_BASE + 0x63c)//not in CODA
...
#define SPM_SLEEP_IDLE_SEL      	(SPM_BASE + 0x78C)//not in CODA
#define SPM_SLEEP_WAKEUP_EVENT_MASK	(SPM_BASE + 0x810)
#define SPM_SLEEP_CPU_WAKEUP_EVENT	(SPM_BASE + 0x814)
#define SPM_SLEEP_MD32_WAKEUP_EVENT_MASK	(SPM_BASE + 0x818)//not in CODA
#define SPM_PCM_WDT_TIMER_VAL		(SPM_BASE + 0x824)
#define SPM_PCM_WDT_TIMER_OUT		(SPM_BASE + 0x828)
#define SPM_PCM_MD32_MAILBOX		(SPM_BASE + 0x830)//not in CODA
#define SPM_PCM_MD32_IRQ		(SPM_BASE + 0x834)//not in CODA
...
#define SPM_SLEEP_MD32_ISR_RAW_STA	(SPM_BASE + 0x914)//not in CODA
...
#define SPM_PCM_WDT_LATCH     (SPM_BASE+0xb24) //TODO: check new feature
...
#define SPM_CA15_CPU0_IRQ_MASK		(SPM_BASE + 0xb40)//not in CODA
#define SPM_CA15_CPU1_IRQ_MASK		(SPM_BASE + 0xb44)//not in CODA
#define SPM_CA15_CPU2_IRQ_MASK		(SPM_BASE + 0xb48)//not in CODA
#define SPM_CA15_CPU3_IRQ_MASK		(SPM_BASE + 0xb4c)//not in CODA
...
#define SPM_SLEEP_CA15_WFI0_EN		(SPM_BASE + 0xf10)//support, not in CODA
#define SPM_SLEEP_CA15_WFI1_EN		(SPM_BASE + 0xf14)//support, not in CODA
#define SPM_SLEEP_CA15_WFI2_EN		(SPM_BASE + 0xf18)//support, not in CODA
#define SPM_SLEEP_CA15_WFI3_EN		(SPM_BASE + 0xf1c)//support, not in CODA
