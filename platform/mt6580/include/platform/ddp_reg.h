...
#define DDP_REG_BASE_MMSYS_CONFIG MMSYS_CONFIG_BASE
#define DDP_REG_BASE_DISP_OVL0    DISP_OVL0_BASE
#define DDP_REG_BASE_DISP_OVL1    0
#define DDP_REG_BASE_DISP_RDMA0   DISP_RDMA0_BASE
#define DDP_REG_BASE_DISP_RDMA1   DISP_RDMA1_BASE
#define DDP_REG_BASE_DISP_RDMA2   0
#define DDP_REG_BASE_DISP_WDMA0   DISP_WDMA0_BASE
#define DDP_REG_BASE_DISP_WDMA1   0
#define DDP_REG_BASE_DISP_COLOR0  DISP_COLOR_BASE
#define DDP_REG_BASE_DISP_COLOR1  0
#define DDP_REG_BASE_DISP_AAL     DISP_AAL_BASE
#define DDP_REG_BASE_DISP_GAMMA   DISP_GAMMA_BASE
...
#define DDP_REG_BASE_DSI0         DSI0_BASE
#define DDP_REG_BASE_DSI1         0
#define DDP_REG_BASE_DPI          DPI_BASE
#define DDP_REG_BASE_DISP_PWM0    DISP_PWM0_BASE
#define DDP_REG_BASE_DISP_PWM1    0
#define DDP_REG_BASE_MM_MUTEX     MM_MUTEX_BASE
#define DDP_REG_BASE_SMI_LARB0    SMI_LARB0_BASE
#define DDP_REG_BASE_SMI_COMMON   SMI_COMMON_BASE
#define DDP_REG_BASE_DISP_OD      0
#define DDP_REG_BASE_DISP_CCORR   DISP_CCORR_BASE
#define DDP_REG_BASE_DITHER       DISP_DITHER_BASE
