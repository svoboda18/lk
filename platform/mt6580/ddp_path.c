...
static mout_t mout_map[DDP_MOUT_NUM] = {
	...
	// DITHER0_MOUT
	{
		...
		DISP_REG_CONFIG_DISP_DITHER_MOUT_EN,
		0
	},
	// UFOE_MOUT
	{
		DISP_MODULE_UFOE,
		{{DISP_MODULE_DSI0, 1<<0}, {DISP_MODULE_DPI, 1<<1}, {DISP_MODULE_WDMA0, 1<<2}, {-1, 0}},
...
static sel_t sel_out_map[DDP_SEL_OUT_NUM] = {
	...
	{
		DISP_MODULE_RDMA1,
		{DISP_MODULE_DSI0, DISP_MODULE_DPI, -1},
...
static sel_t sel_in_map[DDP_SEL_IN_NUM] = {
	...
	{
		DISP_MODULE_DSI0,
		{DISP_MODULE_UFOE, DISP_MODULE_RDMA0, DISP_MODULE_RDMA1, -1},
		DISP_REG_CONFIG_DSI0_SEL_IN,
		0
	},
	...
	{
		DISP_MODULE_WDMA0,
		{DISP_MODULE_OVL0, DISP_MODULE_DITHER, DISP_MODULE_UFOE, -1},
