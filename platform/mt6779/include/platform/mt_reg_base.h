...
#define IOCFG_BR_BASE (0x11D10000)
...
// APB Module dbgao
#define DBGAO_BASE (0x0D010000)
#define DBG_MON_LATCH_CON (0x0D01A100)
#define INFRA_AO_MON_0 (0x0D01A104)
#define INFRA_AO_MON_1 (0x0D01A108)
#define INFRA_AO_MON_2 (0x0D01A10C)
#define INFRA_AO_MON_3 (0x0D01A110)
...
#define MSDC1_TOP_BASE (0x11E10000)
...
#define DISP_WDMA1_BASE (0)
#define DISP_UFOE_BASE (0)
//#define DISP_SPLIT0_BASE (0)
#define DSI0_BASE (0x14014000)
#define DSI1_BASE (0)
#define MM_MUTEX_BASE (0x14016000)

// PQ and AAL
#define COLOR0_BASE (0x1400E000)

//#define COLOR1_BASE (0x14015000)
#define CCORR0_BASE  (0x1400F000)
...
#define DITHER0_BASE (0x14012000)
...
#define DISP_POSTMASK_BASE (0x14021000)
