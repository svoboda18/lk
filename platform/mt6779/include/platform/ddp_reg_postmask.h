...
#ifndef _DDP_REG_POSTMASK_H_
#define _DDP_REG_POSTMASK_H_

#define DISP_REG_POSTMASK_EN	((DISPSYS_POSTMASK_BASE) + 0x000UL)
	#define EN_FLD_POSTMASK_EN	REG_FLD_MSB_LSB(0, 0)

#define DISP_REG_POSTMASK_RESET	((DISPSYS_POSTMASK_BASE) + 0x004UL)
	#define RESET_FLD_POSTMASK_RESET	REG_FLD_MSB_LSB(0, 0)

#define DISP_REG_POSTMASK_INTEN	((DISPSYS_POSTMASK_BASE) + 0x008UL)
...
#define DISP_REG_POSTMASK_INTSTA	((DISPSYS_POSTMASK_BASE) + 0x00CUL)
...
#define DISP_REG_POSTMASK_CFG	((DISPSYS_POSTMASK_BASE) + 0x020UL)
...
#define DISP_REG_POSTMASK_SIZE	((DISPSYS_POSTMASK_BASE) + 0x030UL)
	#define PM_SIZE_FLD_HSIZE	REG_FLD_MSB_LSB(28, 16)
	#define PM_SIZE_FLD_VSIZE	REG_FLD_MSB_LSB(12, 0)

#define DISP_REG_POSTMASK_SRAM_CFG	((DISPSYS_POSTMASK_BASE) + 0x040UL)
...
#define DISP_REG_POSTMASK_MASK_SHIFT	((DISPSYS_POSTMASK_BASE) + 0x044UL)
...
#define DISP_REG_POSTMASK_GRAD_SHIFT	((DISPSYS_POSTMASK_BASE) + 0x048UL)
...
#define DISP_REG_POSTMASK_BLEND_CFG	((DISPSYS_POSTMASK_BASE) + 0x050UL)
...
#define DISP_REG_POSTMASK_ROI_BGCLR	((DISPSYS_POSTMASK_BASE) + 0x054UL)
...
#define DISP_REG_POSTMASK_MASK_CLR	((DISPSYS_POSTMASK_BASE) + 0x058UL)
...
#define DISP_REG_POSTMASK_STATUS	((DISPSYS_POSTMASK_BASE) + 0x0A0UL)
...
#define DISP_REG_POSTMASK_INPUT_COUNT	((DISPSYS_POSTMASK_BASE) + 0x0A4UL)
	#define PM_INPUT_COUNT_FLD_INP_LINE_CNT	REG_FLD_MSB_LSB(28, 16)
	#define PM_INPUT_COUNT_FLD_INP_PIX_CNT	REG_FLD_MSB_LSB(12, 0)

#define DISP_REG_POSTMASK_DEBUG_0	((DISPSYS_POSTMASK_BASE) + 0x0B0UL)
#define DISP_REG_POSTMASK_DEBUG_1	((DISPSYS_POSTMASK_BASE) + 0x0B4UL)
#define DISP_REG_POSTMASK_DEBUG_2	((DISPSYS_POSTMASK_BASE) + 0x0B8UL)
#define DISP_REG_POSTMASK_MEM_ADDR	((DISPSYS_POSTMASK_BASE) + 0x100UL)
#define DISP_REG_POSTMASK_MEM_LENGTH	((DISPSYS_POSTMASK_BASE) + 0x104UL)
#define DISP_REG_POSTMASK_RDMA_FIFO_CTRL	((DISPSYS_POSTMASK_BASE) + 0x108UL)

#define DISP_REG_POSTMASK_MEM_GMC_SETTING2	((DISPSYS_POSTMASK_BASE) + 0x10CUL)
...
#define DISP_REG_POSTMASK_PAUSE_REGION	((DISPSYS_POSTMASK_BASE) + 0x110UL)
...
#define DISP_REG_POSTMASK_RDMA_GREQ_NUM	((DISPSYS_POSTMASK_BASE) + 0x130UL)
...
#define DISP_REG_POSTMASK_RDMA_GREQ_URG_NUM	((DISPSYS_POSTMASK_BASE) + 0x134UL)
	#define PM_GREQ_URG_FLD_ARB_URG_BIAS	REG_FLD_MSB_LSB(12, 12)
	#define PM_GREQ_URG_FLD_ARB_GREQ_URG_TH	REG_FLD_MSB_LSB(11, 0)

#define DISP_REG_POSTMASK_RDMA_ULTRA_SRC	((DISPSYS_POSTMASK_BASE) + 0x140UL)
...
#define DISP_REG_POSTMASK_RDMA_BUF_LOW_TH	((DISPSYS_POSTMASK_BASE) + 0x144UL)
	#define PM_TH_FLD_RDMA_PREULTRA_LOW_TH	REG_FLD_MSB_LSB(23, 12)
	#define PM_TH_FLD_RDMA_ULTRA_LOW_TH	REG_FLD_MSB_LSB(11, 0)

#define DISP_REG_POSTMASK_RDMA_BUF_HIGH_TH	((DISPSYS_POSTMASK_BASE) + 0x148UL)
...
#define DISP_REG_POSTMASK_NUM_0	((DISPSYS_POSTMASK_BASE) + 0x800UL)
...
#define DISP_REG_POSTMASK_GRAD_VAL_0	((DISPSYS_POSTMASK_BASE) + 0xA00UL)
...
#define DISP_REG_POSTMASK_GRAD_VAL(n)	\
	(DISP_REG_POSTMASK_GRAD_VAL_0 + (0x4 * (n)))


#endif /* _DDP_REG_POSTMASK_H_ */
