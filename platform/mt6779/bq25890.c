...
{
	bq25890_set_wd_timer(0); // disable wdt
	...
	/* Disable HVDCP and MaxCharge */
	bq25890_config_interface(bq25890_CON2, 0, CON2_MAXC_EN_MASK, CON2_MAXC_EN_SHIFT);
	bq25890_config_interface(bq25890_CON2, 0, CON2_HVDCP_EN_MASK, CON2_HVDCP_EN_SHIFT);
