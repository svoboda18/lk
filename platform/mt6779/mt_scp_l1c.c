...
static l1c_status_t l1c_set_size(uint32_t l1c_type, l1c_size_t l1c_size)
{
	/* L1C size is invalid */
...
static l1c_status_t l1c_region_enable(uint32_t l1c_type, l1c_region_t region)
{
	/* Region is invalid */
...
static l1c_status_t l1c_region_config(uint32_t l1c_type, l1c_region_t region,
...
static l1c_status_t l1c_enable(uint32_t l1c_type)
{
	/* Enable L1C */
...
static l1c_status_t l1c_invalidate_all_l1c_lines(uint32_t l1c_type)
{
...
static l1c_status_t l1c_init(uint32_t l1c_type)
{
	l1c_region_t region;
