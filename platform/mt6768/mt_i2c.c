...
void _i2c_dump_info(mt_i2c *i2c)
{
	...
	I2CERR("I2C register:\n"
	       ...
	       I2CTAG"IO_CONFIG=%x,HS=%x,HW_CG_EN=%x,DEBUGSTAT=%x,EXT_CONF=%x,TRANSFER_LEN_AUX=%x\n",
...
S32 _i2c_transfer_interface(mt_i2c *i2c)
{
	...
	i2c->control_reg = I2C_CONTROL_ACKERR_DET_EN | I2C_CONTROL_IRQ_SEL;
#else
	i2c->control_reg = I2C_CONTROL_ACKERR_DET_EN | I2C_CONTROL_IRQ_SEL
