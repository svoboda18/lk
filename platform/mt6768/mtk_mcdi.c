...
static void mcdi_get_cpc_info(void)
{
	...
	DRV_WriteReg32(MCDI_SRAM_REG(0x7C0), DRV_Reg32(MCUCFG_REG(0x3214)) & 0x000003FF);
	DRV_WriteReg32(MCDI_SRAM_REG(0x7C4), DRV_Reg32(MCUCFG_REG(0x3A14)) & 0x000003FF);
