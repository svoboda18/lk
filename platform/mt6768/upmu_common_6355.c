...
const PMU_FLAG_TABLE_ENTRY pmu_flags_table[] = {
	...
	PMIC_ENTRY(PMIC_BIF_RX_ERROR_UNKNOW),
...
unsigned short mt6355_set_register_value(PMU_FLAGS_LIST_ENUM flagname, unsigned int val)
{
...
unsigned short mt6355_get_register_value(PMU_FLAGS_LIST_ENUM flagname)
{
	const PMU_FLAG_TABLE_ENTRY *pFlag = &pmu_flags_table[flagname];
	unsigned int val;
	unsigned int ret;
...
{
	return mt6355_set_register_value(flagname, val);
}


unsigned short pmic_get_register_value(PMU_FLAGS_LIST_ENUM flagname)
{
	return mt6355_get_register_value(flagname);
}
