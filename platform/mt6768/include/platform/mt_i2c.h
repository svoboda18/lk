...
#define I2C_NR      9 /* Number of I2C controllers */
...
#ifndef I2C2_BASE
#define I2C2_BASE (I2C2_BASE_SE + 0x100)
#endif
#ifndef I2C2_BASE_SE
#define I2C2_BASE_SE (0x11009000)
#endif

#ifndef I2C3_BASE
#define I2C3_BASE (I2C3_BASE_SE + 0x100)
#endif
#ifndef I2C3_BASE_SE
#define I2C3_BASE_SE (0x1100F000)
#endif

#ifndef I2C4_BASE
#define I2C4_BASE (I2C4_BASE_SE + 0x100)
#endif
#ifndef I2C4_BASE_SE
#define I2C4_BASE_SE (0x11011000)
#endif

#ifndef I2C5_BASE
#define I2C5_BASE (0x11016000)
#endif


#ifndef I2C6_BASE
#define I2C6_BASE (0x1100D000)
#endif


#ifndef I2C7_BASE
#define I2C7_BASE (0x11004000)
#endif


#ifndef I2C8_BASE
#define I2C8_BASE (0x11005000)
#endif

#define I2C0_APDMA_BASE (0x11000080)
#define I2C1_APDMA_BASE (0x11000100)
#define I2C2_APDMA_BASE (0x11000180)
#define I2C3_APDMA_BASE (0x11000300)
#define I2C4_APDMA_BASE (0x11000400)
#define I2C5_APDMA_BASE (0x11000580)
#define I2C6_APDMA_BASE (0x11000600)
#define I2C7_APDMA_BASE (0x11000680)
#define I2C8_APDMA_BASE (0x11000800)
...
enum I2C_REGS_OFFSET {
  ...
  OFFSET_HTIMING         = 0x20,   //0X20
  OFFSET_START          = 0x24,   //0X24
  OFFSET_EXT_CONF       = 0x28,
  OFFSET_LTIMING        = 0x2C,
  OFFSET_FIFO_STAT      = 0xf4,   //0Xf4
  OFFSET_FIFO_THRESH    = 0xf8,   //0Xf8
  OFFSET_FIFO_ADDR_CLR  = 0x38,   //0X38
  OFFSET_IO_CONFIG      = 0x34,   //0X40
  OFFSET_HS             = 0x30,   //0X48
  OFFSET_SOFTRESET      = 0x50,   //0X50
  OFFSET_DEBUGSTAT      = 0xe4,   //0X64
  OFFSET_DEBUGCTRL      = 0xe8,   //0x68
  OFFSET_TRANSFER_LEN_AUX      = 0x44,   //0x6C
  OFFSET_MULTIMAS       = 0xf0,   //0xf0;
  OFFSET_AED_PATCH      = 0x80,   //0x80
  OFFSET_HW_CG_EN       = 0xf88,  //0xf88
  OFFSET_MULTI_DMA      = 0xf8c,
  OFFSET_TIMEOUT_DIV    = 0x4C,   //0X4C
