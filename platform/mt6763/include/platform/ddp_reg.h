...
#define DISPSYS_AAL0_BASE               DISP_AAL_BASE
#define DISPSYS_GAMMA0_BASE             DISP_GAMMA_BASE
#define DISPSYS_SPLIT0_BASE             DISP_SPLIT0_BASE
#define DISPSYS_DSI0_BASE               DSI0_BASE
#define DISPSYS_DITHER0_BASE            DITHER_BASE
...
#define DISPSYS_CCORR0_BASE             CCORR_BASE
