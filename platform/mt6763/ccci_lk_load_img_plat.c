...
#define CCCI_SMEM_SIZE_DFD (256*1024)
...
#define MAX_SMEM_SIZE       0x10000000/*Change from 6M to 256M,0x600000*/
...
static int cal_share_mem_size(void)
{
	...
	ap_md1_smem_size = str2uint(get_env("apmd1_smem"));
	md1_md3_smem_size = str2uint(get_env("md1md3_smem"));
	ap_md3_smem_size = str2uint(get_env("apmd3_smem"));
	...
	ALWAYS_LOG("total_smem_size = 0x%x; ap_md1_smem_size = 0x%x; md1_phy_cap_size = 0x%x\n",
		smem_info.total_smem_size, smem_info.ap_md1_smem_size, md1_phy_cap_size);
...
#define MPU_REGION_ID_MD_DRDI           9
...
#define MPU_REGION_ID_MD1_CCB           21
#define MPU_REGION_ID_MD1_SMEM          22

#define MPU_REGION_ID_AP                31
#define MPU_REGION_ID_TOTAL_NUM         (MPU_REGION_ID_AP + 1)

#define MPU_MDOMAIN_ID_AP       0
#define MPU_MDOMAIN_ID_MD1      9
#define MPU_MDOMAIN_ID_MDHW     15
...
static const mpu_att_t mpu_att_default[MPU_REGION_ID_TOTAL_NUM][MPU_MDOMAIN_ID_TOTAL_NUM] = {
	...
	/* 4*/{}, /*Set in TEE MD1 SEC MEM*/
	/* 5*/{}, /*Tinysys-SCP ROM*/
	/* 6*/{}, /*Tinysys-SCP share buffer*/
	/* 7*/{}, /*Set in TEE MD1 SEC MEM*/
	/* 8*/{}, /*MD Dynamic*/
	/* 9*/{ SEC_R_NSEC_R,   SEC_R_NSEC_R, [2 ... 6] = FORBIDDEN, SEC_R_NSEC_R,    [8 ... 15] = FORBIDDEN}, /*DRDI*/
	/*10*/{ SEC_R_NSEC_R,   NO_PROTECTION, [2 ... 6] = FORBIDDEN, NO_PROTECTION,    [8 ... 15] = FORBIDDEN},
	/*11*/{ SEC_R_NSEC_R,   SEC_R_NSEC_R,  [2 ... 6] = FORBIDDEN, SEC_R_NSEC_R,     [8 ... 15] = FORBIDDEN},
	/*12*/{ SEC_R_NSEC_R,   NO_PROTECTION, [2 ... 6] = FORBIDDEN, SEC_R_NSEC_R,     [8 ... 15] = FORBIDDEN},
	/*13*/{ SEC_R_NSEC_R,   SEC_R_NSEC_R,  [2 ... 6] = FORBIDDEN, NO_PROTECTION,    [8 ... 15] = FORBIDDEN},
	...
	/*21*/{ NO_PROTECTION,  NO_PROTECTION, [2 ... 6] = FORBIDDEN, NO_PROTECTION,    [8 ... 15] = FORBIDDEN},
	/*22*/{ NO_PROTECTION,  NO_PROTECTION, [2 ... 6] = FORBIDDEN, NO_PROTECTION,    [8 ... 15] = FORBIDDEN},
	/*23*/{}, /*Set in LK MD Padding1*/
	/*24*/{}, /*Set in LK MD Padding2*/
	/*25*/{}, /*Set in LK MD Padding3*/
	/*26*/{}, /*Set in LK MD Padding4*/
	/*27*/{}, /*Set in LK MD Padding5*/
	/*28*/{}, /*Set in LK MD Protect*/
	/*29*/{}, /*Set in LK MD dynamic*/
	/*30*/{},/*Set in Kernel AP*/
	/*31*/{
...
static void set_gear_id_list()
{
	...
	ret = set_env("md1_ccb_gear_list", "1(2,20);2(2,10);3(0,0);11(2,2)");
	if (ret) {
...
static int cal_share_mem_layout(int load_flag)
{
	...
	if (md1_ccb_size)
		ccb_data_buf = ccci_request_mem(md1_ccb_size, 0x90000000LL, 0x2000000L);
