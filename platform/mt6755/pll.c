...
void mt_pll_turn_off(void)
{
	...
	//DRV_WriteReg32(MMPLL_CON0, temp & ~(1<<PLL_CON0_EN_BIT));
    ...
    *******************/
	...
	//DRV_WriteReg32(MMPLL_PWR_CON0, temp | (1<<PLL_PWR_CON0_ISO_EN_BIT));
    ...
    **************/
	//temp = DRV_Reg32(MMPLL_PWR_CON0);
	//DRV_WriteReg32(MMPLL_PWR_CON0, temp & ~(1<<PLL_PWR_CON0_PWR_ON_BIT));
