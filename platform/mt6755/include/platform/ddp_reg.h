...
#define DDP_REG_BASE_DISP_COLOR1     0 //COLOR1_BASE       //0xf4014000
#define DDP_REG_BASE_DISP_MERGE      0 //DISP_MERGE_BASE   //0xf4017000
#define DDP_REG_BASE_DISP_SPLIT0     0 //DISP_SPLIT0_BASE  //0xf4018000
#define DDP_REG_BASE_DISP_SPLIT1     0 //DISP_SPLIT1_BASE  //0xf4019000
#define DDP_REG_BASE_DISP_UFOE       0 //DISP_UFOE_BASE    //0xf401A000
#define DDP_REG_BASE_DSI1            0 //DSI1_BASE         //0xf401C000
#define DDP_REG_BASE_DISP_PWM1       0 //DISP_PWM1_BASE    //0xf401F000
#define DDP_REG_BASE_DISP_OD         0 //DISP_OD_BASE      //0xf4023000
...
#define MMSYS_CG_FLD_CG0_UFOE                                  REG_FLD(1, 20)
...
#define MMSYS_CG_FLD_CG1_DPI_PIX                               REG_FLD(1, 8)
#define MMSYS_CG_FLD_CG1_DPI_ENG                               REG_FLD(1, 9)
...
#define DISP_REG_OVL_L0_CLIP                                        (DISPSYS_OVL0_BASE + 0x04C)
...
#define DISP_REG_OVL_L1_CLIP                                        (DISPSYS_OVL0_BASE + 0x06C)
...
#define DISP_REG_OVL_L2_CLIP                                        (DISPSYS_OVL0_BASE + 0x08C)
...
#define DISP_REG_OVL_L3_CLIP                                        (DISPSYS_OVL0_BASE + 0x0AC)
...
#define DISP_REG_OVL_LC_CLR                                         (DISPSYS_OVL0_BASE + 0x26C)
#define DISP_REG_OVL_CRC                                            (DISPSYS_OVL0_BASE + 0x270)
#define DISP_REG_OVL_LC_CON                                         (DISPSYS_OVL0_BASE + 0x280)
#define DISP_REG_OVL_LC_SRCKEY                                      (DISPSYS_OVL0_BASE + 0x284)
#define DISP_REG_OVL_LC_SRC_SIZE                                    (DISPSYS_OVL0_BASE + 0x288)
#define DISP_REG_OVL_LC_OFFSET                                      (DISPSYS_OVL0_BASE + 0x28C)
#define DISP_REG_OVL_LC_SRC_SEL                                     (DISPSYS_OVL0_BASE + 0x290)
#define DISP_REG_OVL_SECURE                                         (DISPSYS_OVL0_BASE + 0x2C0)
