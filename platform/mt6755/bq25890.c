...
kal_uint32 bq25890_get_idpm_lim(void)
{
	kal_uint32 ret=0;
	kal_uint8 val=0;
	ret=bq25890_read_interface((kal_uint8)(bq25890_CON13),
	                           (&val),
	                           (kal_uint8)(CON13_IDPM_LIM_MASK),
	                           (kal_uint8)(CON13_IDPM_LIM_SHIFT)
	                          );
	return val;
}
/**********************************************************
...
void bq25890_charging_enable(kal_uint32 bEnable)
{
	...
	dprintf(CRITICAL, "[BATTERY:bq24196] charger enable/disable %d !\r\n", bEnable);
}
...
static void hw_bc11_dump_register(void)
{
	...
	dprintf(INFO, "Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n",
	        MT6353_CHR_CON20, upmu_get_reg_value(MT6353_CHR_CON20),
	        MT6353_CHR_CON21, upmu_get_reg_value(MT6353_CHR_CON21)
	       );
#else
	dprintf(INFO, "Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n",
