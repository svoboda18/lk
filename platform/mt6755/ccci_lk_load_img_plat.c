...
static const int free_mpu_region[] = {MPU_REGION_ID_RESERVED1, MPU_REGION_ID_RESERVED2, -1};
...
int plat_dt_reserve_mem_size_fixup(void *fdt)
{
	...
	if (offset < 0) {
		ALWAYS_LOG("plat_dt_reserve_mem_size_fixup fail\n");
		return;
	}
...
#define AP_MD1_SMEM_SIZE    0x20000 /* 128k */
#define MD1_MD3_SMEM_SIZE   0x60000 /* 384k */
#define AP_MD3_SMEM_SIZE    0xD0000 /* 832k */
