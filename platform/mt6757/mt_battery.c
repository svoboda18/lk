...
#if defined(MTK_BQ25896_SUPPORT)
	bq25896_hw_init();
	bq25896_charging_enable(bEnable);
...
void enable_dummy_load(kal_uint32 en)
{
	...
	if (en==1) {
		...
		*/
		...
		pmic_set_register_value(MT6351_PMIC_ISINK_CH3_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CH2_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CHOP7_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CHOP6_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CHOP3_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CHOP2_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CH7_BIAS_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CH6_BIAS_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CH3_BIAS_EN, 0);
		pmic_set_register_value(MT6351_PMIC_ISINK_CH2_BIAS_EN, 0);

		/*1. enable isink pdn */
		pmic_set_register_value(MT6351_PMIC_RG_DRV_ISINK3_CK_PDN, 0x1);
		pmic_set_register_value(MT6351_PMIC_RG_DRV_ISINK2_CK_PDN, 0x1);
		pmic_set_register_value(MT6351_PMIC_RG_DRV_32K_CK_PDN, 0x1);

		/*1. enable isink pdn */
		pmic_set_register_value(MT6351_PMIC_RG_DRV_CHRIND_CK_PDN, 0x1);
		pmic_set_register_value(MT6351_PMIC_RG_DRV_ISINK7_CK_PDN, 0x1);
		pmic_set_register_value(MT6351_PMIC_RG_DRV_ISINK6_CK_PDN, 0x1);
