...
{
	// Copy from Jade kernel code: alps\kernel-3.18\drivers\misc\mediatek\power\mt6757 =====
	unsigned int ret;
...
//=============================================
// MD1 PMIC setting
// porting from vmd1_pmic_setting_on(void) in drivers/misc/mediatek/power/mt6757/pmic.c
