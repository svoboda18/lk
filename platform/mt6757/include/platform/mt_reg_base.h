...
#define MM_MUTEX_BASE (0x14025000)

// PQ and AAL
#define COLOR0_BASE (0x14014000)
#define CCORR_BASE  (0x14016000)
#define DISP_AAL_BASE (0x14018000)
#define DISP_GAMMA_BASE (0x1401a000)
#define DISP_OD_BASE (0x1401c000)
#define DITHER_BASE (0x1401d000)


// APB Module disp_dpi
#define DPI_BASE (0x14024000)

// APB Module disp_pwm
#define DISP_PWM0_BASE (0x1100e000)

// APB Module smi_larb0
#define SMI_LARB0_BASE (0x14026000)

// APB Module smi_larb5
#define SMI_LARB4_BASE (0x14027000)

// APB Module smi
#define SMI_COMMON_BASE (0x14028000)
...
#define GIC_REDIS_BASE (0x0C200000)
...
#ifdef MACH_FPGA
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT0,921600n1 " CMDLINE_ROOT " androidboot.hardware=mt6757 firmware_class.path=/vendor/firmware"
#else
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT3,921600n1 " CMDLINE_ROOT " vmalloc=496M slub_max_order=0 slub_debug=OFZPU androidboot.hardware=mt6757 firmware_class.path=/vendor/firmware"
#endif
