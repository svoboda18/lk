...
#ifdef LK_PROFILING
	dprintf(INFO, "[PROFILE] ------- sec func init takes %d ms -------- \n", (int)get_timer(time_vb_init));
#endif
#endif
	return;
}
...
#ifdef LK_PROFILING
	dprintf(INFO, "[PROFILE] ------- vfy logo takes %d ms -------- \n", (int)get_timer(time_vfy_logo));
#endif
#endif
	return;
}
...
#ifdef LK_PROFILING
	dprintf(INFO, "[PROFILE] ------- vfy dtbo takes %d ms -------- \n", (int)get_timer(time_vfy_dtbo));
#endif
#endif
	return;
}
