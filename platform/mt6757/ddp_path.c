...
int ddp_path_top_clock_on(void)
{
	...
	ddp_enable_module_clock(DISP_MODULE_SMI_LARB4);
...
int ddp_path_top_clock_off(void)
{
	...
	ddp_disable_module_clock(DISP_MODULE_SMI_LARB4);
...
int ddp_path_m4u_off(void)
{
	...
	*/
	for (i=0; i<1; i++)
		DISP_REG_SET_FIELD(0, REG_FLD_MMU_EN, DISP_REG_SMI_LARB4_MMU_EN + i*4, 0);
	/*
		M4U_PORT_DISP_2L_OVL0_LARB4,
	*/
	DISP_REG_SET_FIELD(0, REG_FLD_MMU_EN, DISP_REG_SMI_LARB4_MMU_EN + 7*4, 0);
#endif
	return 0;
}
