 ...
 ******************************************************************************/
/*
 * NOTE: C_DATx will not support Multi-Bit ECC once you have blown either one.
 *       The API will disable the HW ECC of C_DATx because C_DAT0 and C_DAT1
 *       share the same ECC. The C_DATx will not be correct if we do not
 *       disable the C_DATx's HW ECC.
 */
#define EFUSE_IDX_C_DAT0            0
#define EFUSE_IDX_C_DAT1            1
#define EFUSE_IDX_C_CTRL0           2
#define EFUSE_IDX_C_CTRL1           3
#define EFUSE_IDX_C_CTRL2           4
#define EFUSE_IDX_C_CTRL3           5
