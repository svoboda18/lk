...
#define IOCFG_BM_BASE (0x10002800)
...
#define MSDC1_TOP_BASE (0x11C40000)
...
// DISPSYS
#define DISP_OVL0_BASE (0x1400a000)
#define DISP_RDMA0_BASE (0x1400b000)
#define DISP_WDMA0_BASE (0x1400c000)
#define DISP_MM_MUTEX_BASE (0x14001000)

// PQ and AAL
#define DISP_COLOR0_BASE (0x1400d000)
#define DISP_CCORR0_BASE  (0x1400e000)
#define DISP_AAL0_BASE (0x1400f000)
#define DISP_GAMMA0_BASE (0x14010000)
#define DISP_DITHER0_BASE (0x14011000)


// APB Module disp_dpi
#define DISP_DBI0_BASE (0x14013000)
#define DISP_DSI0_BASE (0x14012000)
