...
#define NFI_CON_REG32       ((volatile P_U32)(NFI_BASE+0x0008))
#define NFI_ACCCON_REG32    ((volatile P_U32)(NFI_BASE+0x000C))
#define NFI_INTR_EN_REG32   ((volatile P_U32)(NFI_BASE+0x0010))
...
#define NFI_ADDRCNTR_REG32  ((volatile P_U32)(NFI_BASE+0x0070))

#define NFI_STRADDR_REG32   ((volatile P_U32)(NFI_BASE+0x0080))
#define NFI_BYTELEN_REG32   ((volatile P_U32)(NFI_BASE+0x0084))
...
#define NFI_CRC01_REG32     ((volatile P_U32)(NFI_BASE+0x0120))
#define NFI_CRC23_REG32     ((volatile P_U32)(NFI_BASE+0x0124))
#define NFI_CRC45_REG32     ((volatile P_U32)(NFI_BASE+0x0128))
#define NFI_CRC67_REG32     ((volatile P_U32)(NFI_BASE+0x012C))
#define NFI_CRC89_REG32     ((volatile P_U32)(NFI_BASE+0x0130))
#define NFI_CRCAB_REG32     ((volatile P_U32)(NFI_BASE+0x0134))
#define NFI_CRCCD_REG32     ((volatile P_U32)(NFI_BASE+0x0138))
#define NFI_CRCEF_REG32     ((volatile P_U32)(NFI_BASE+0x013C))
...
#define NFI_MASTERSTA_REG32  ((volatile P_U32)(NFI_BASE+0x0224))
#define NFI_MASTERRST_REG32  ((volatile P_U32)(NFI_BASE+0x0228))

#define NFI_RANDOM_CNFG_REG32    ((volatile P_U32)(NFI_BASE+0x0238))
#define NFI_EMPTY_THRESHOLD      ((volatile P_U32)(NFI_BASE+0x023C))
#define NFI_NAND_TYPE_CNFG_REG32 ((volatile P_U32)(NFI_BASE+0x0240))
#define NFI_ACCCON1_REG32        ((volatile P_U32)(NFI_BASE+0x0244))
#define NFI_DLYCTRL_REG32        ((volatile P_U32)(NFI_BASE+0x0248))

#define NFI_RANDOM_TSB_SEED0     ((volatile P_U32)(NFI_BASE+0x024C))
#define NFI_RANDOM_TSB_SEED15    ((volatile P_U32)(NFI_BASE+0x0290))

#define NFI_TLC_RD_WHR2_REG16    ((volatile P_U16)(NFI_BASE+0x0300))
#define NFI_DQS_HIGH_SET         ((volatile P_U32)(NFI_BASE+0x0304))
#define NFI_DQS_CMP_MODE         ((volatile P_U32)(NFI_BASE+0x0308))
...
/******************************************************************************
* NFI Clock Register Definition
******************************************************************************/

#define MT_CLKMUX_NFI_INFRA_UPD     ((volatile P_U32)(0x10000000+0x0004))
#define MT_CLKMUX_NFI_INFRA_SEL     ((volatile P_U32)(0x10000000+0x00B0))
#define HF_FNFI2X_CK_UPDATE_SHIFT   28
#define HF_FNFIECC_CK_UPDATE_SHIFT  29

#define PDN_NFIECC_SHIFT            23
#define CLK_NFIECC_INV_SHIFT        20
#define CLK_NFIECC_SEL_SHIFT        16    // 18:16

#define PDN_NFI2X_SHIFT             15
#define CLK_NFI2X_INV_SHIFT         12
#define CLK_NFI2X_SEL_SHIFT         8     // 10:8


/******************************************************************************
* NFI Clock Register Field Definition
******************************************************************************/

#define CLK_NFI_CLOCK_ON            0
#define CLK_NFI_CLOCK_OFF           1

#define CLK_NFI_CLK_MASK            7

#define CLK_NFIECC_CLK_26M          0
#define CLK_NFIECC_CLK_78M          1
#define CLK_NFIECC_CLK_104M         2
#define CLK_NFIECC_CLK_156M         3
#define CLK_NFIECC_CLK_312M         4
#define CLK_NFIECC_CLK_273M         5
#define CLK_NFIECC_CLK_208M         6
#define CLK_NFIECC_CLK_218M         7

#define CLK_NFI2X_CLK_26M           0
#define CLK_NFI2X_CLK_182M          1
#define CLK_NFI2X_CLK_156M          2
#define CLK_NFI2X_CLK_364M          3
#define CLK_NFI2X_CLK_91M           4
#define CLK_NFI2X_CLK_200M          5
#define CLK_NFI2X_CLK_312M          6
#define CLK_NFI2X_CLK_250M          7
...
#if defined(MTK_TLC_NAND_SUPPORT) // tlc command
