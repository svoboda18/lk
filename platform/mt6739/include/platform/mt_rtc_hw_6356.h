...
#ifndef __MT_RTC_HW_MT6356_H__
#define __MT_RTC_HW_MT6356_H__
...
#define RTC_EMBCK_SEL_DCXO 		(0 << 6)	/*	0:dcxo_ck	1:eosc32_ck	2:emb_k_eosc_32	3: emb_hw	*/
