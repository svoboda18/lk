...
typedef struct {
	...
	u32 plat_dbg_info_max;
	dbg_info_in_bootargs plat_dbg_info[INFO_TYPE_MAX];
	char	pl_version[8];
	...
	u32 boot_voltage;
	u32 shutdown_time;
	u32	ram_console_sram_addr;
	u32	ram_console_sram_size;
	u32	ram_console_def_type;
	u32	ram_console_memory_info_offset;
...
#define BOOT_TAG_IMGVER_INFO      0x88610015
struct boot_tag_imgver_info {
	u32 pl_imgver_status;
};


/* max cpus */
#define BOOT_TAG_MAX_CPUS       0x88610016
struct boot_tag_max_cpus {
	u32 max_cpus;
};
