...
int lastbus_mcusys_dump(const struct plt_cfg_bus_latch *self, char *buf, int *wp);
...
const struct plt_cfg_pc_latch cfg_pc_latch = {
	...
	.mp0_dbg_ctrl = 0x0,
	.mp0_dbg_flag = 0x0,
	.mp1_dbg_ctrl = 0x0,	/* not support */
	.mp1_dbg_flag = 0x0,	/* not support */
	.spm_pwr_sts = 0x080c,
	.plat_sram_flag0 = 0x0,
	.dump = plat_lastpc_dump,
};
...
const struct plt_cfg_bus_latch cfg_bus_latch = {
	...
	.num_infrasys_mon = 15,
	.mcusys_ops = {
		.dump = lastbus_mcusys_dump,
	},
	.mcusys_offsets = {
		.bus_mcu_m0 = 0xDEADBEEF,	/* not support */
		.bus_mcu_s1 = 0xDEADBEEF,	/* not support */
		.bus_mcu_m0_m = 0x04B0,
		.bus_mcu_s1_m = 0x04B8,
	},
	.perisys_offsets = {
