...
/* Low battery voltage threshold: 3.65V */
#define PICACHU_LOW_BAT_VOLT	(3650)

/*
 * The following function 'picachu_check_bat_low_voltage' is invoked
 * by libpicachu.a to check if the battery is under low voltage.
 */
...
int picachu_check_bat_low_voltage(void)
{
	...
	return val <= PICACHU_LOW_BAT_VOLT ? true : false;
}
