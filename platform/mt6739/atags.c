...
/*
 * FIXME:	MT6739 doesn't have the project code attribute (always 0),
 *			so should be filled in a corrsponding value for other proejcts.
 */
#define PROJ_CODE   0
...
int target_fdt_model(void *fdt)
{
	...
	unsigned int spare2 = get_devinfo_with_index(5) & 0xFF;

	int len;
	int nodeoffset, namestroff;
	...
	if (!prop) {
		dprintf(CRITICAL, "Warning: No model property\n");
		return 0;
	}

	switch(segment){
		case 0x0:
			model_name = "MT6739CW-ENG2";
			break;
		case 0x20:
			model_name = "MT6739-ENG";
			break;
		case 0x08:
			model_name = "MT6739WW-ENG1";
			break;
		case 0x2D:
			model_name = "MT6739WA-ENG3";
			break;
		case 0x2E:
			model_name = "MT6739WM-ENG5";
			break;
		case 0xAD:
			model_name = "MT6739WA";
			break;
		...
		case 0xAE:
			...
			break;
		case 0x40:
			model_name = "MT8765-ENG";
			break;
		case 0x48:
			model_name = "MT8765-ENG1";
			break;
		case 0xED:
			model_name = "MT8765WB";
			break;
		...
		case 0xB8:
			...
			break;
		case 0x38:
			model_name = "MT6731-ENG1";
			break;
		default:
			goto _err;
	}

	dprintf(CRITICAL, "proj_code=0x%x, segment=0x%x, spare2=0x%x, model_name=%s\n",
							proj_code, segment, spare2, model_name);
...
_err:
	dprintf(CRITICAL, "Error: proj_code=0x%x, segment=0x%x\n", proj_code, segment);
	return -1;
}
