...
static void _pwrap_InitStaUpd(void)
{
	...
	WRAP_WR32(PMIC_WRAP_INT_GPS_AUXADC_CMD, (0x0040 << 16) + 0x0080);
...
static void _pwrap_enable(void)
{
	...
	WRAP_WR32(PMIC_WRAP_HPRIO_ARB_EN, 0x3fa75);
#endif
