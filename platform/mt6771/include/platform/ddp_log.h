...
#define DISP_LOG_E( fmt, args...)   dprintf(CRITICAL,"[LK_DDP/"LOG_TAG"]error:"fmt,##args)
...
#define DDPERR(string, args...)    dprintf(CRITICAL,"[LK_DDP/"LOG_TAG"]error:"string,##args)  //default on, err msg
#define DDPDBG(string, args...)     dprintf(DDP_DFINFO,"[LK_DDP/"LOG_TAG"]"string,##args)  // default on, important msg, not err

#define DDPDUMP(string, args...)    dprintf(CRITICAL,"[LK_DDP/"LOG_TAG"]"string,##args)  // default on, important msg, not err
#endif
