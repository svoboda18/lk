...
#else
/* DO NOT modify the following setting */
struct otp_group_info otp_group_list[] = {
	{SECURE_GROUP,     1, 0, 0, 0, 0, 0},
	{NON_SECURE_GROUP, 7, 0, 0, 0, 0, 0},
	{AVB_GROUP,        0, 0, 0, 0, 0, 0},
	{RECOVERY_GROUP,   0, 0, 0, 0, 0, 0},
	{MISC_GROUP,       0, 0, 0, 0, 0, 0}
};
#endif
